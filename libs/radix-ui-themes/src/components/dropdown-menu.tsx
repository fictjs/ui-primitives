...
const DropdownMenuRoot: React.FC<DropdownMenuRootProps> = (props) => (
  <DropdownMenuPrimitive.Root {...mergeProps(prop(() => props as Record<string, unknown>))} />
)
...
const DropdownMenuContentContext = createContext<DropdownMenuContentContextValue>({})
...
const DropdownMenuLabel = React.forwardRef<DropdownMenuLabelElement, DropdownMenuLabelProps>(
  ({ className, ...props }, forwardedRef) => (
    <DropdownMenuPrimitive.Label
      {...props}
      ref={React.coerceRef(forwardedRef)}
      class={classNames('rt-BaseMenuLabel', 'rt-DropdownMenuLabel', className)}
    />
  ),
)
  ...
  (props, forwardedRef) => {
    ...
    return (
      <DropdownMenuPrimitive.Item
        ...
        {...itemProps}
        ref={React.coerceRef(forwardedRef)}
        class={classNames('rt-reset', 'rt-BaseMenuItem', 'rt-DropdownMenuItem', className)}
      >
        <Slot.Slottable>{children}</Slot.Slottable>
        {shortcut && <div class="rt-BaseMenuShortcut rt-DropdownMenuShortcut">{shortcut}</div>}
      </DropdownMenuPrimitive.Item>
    )
  },
)
...
const DropdownMenuGroup = React.forwardRef<DropdownMenuGroupElement, DropdownMenuGroupProps>(
  ({ className, ...props }, forwardedRef) => (
    <DropdownMenuPrimitive.Group
      {...props}
      ref={React.coerceRef(forwardedRef)}
      class={classNames('rt-BaseMenuGroup', 'rt-DropdownMenuGroup', className)}
    />
  ),
)
...
>((props, forwardedRef) => {
  ...
  return (
    ...
    >
      {children}
      <DropdownMenuPrimitive.ItemIndicator class="rt-BaseMenuItemIndicator rt-DropdownMenuItemIndicator">
        <ThickCheckIcon class="rt-BaseMenuItemIndicatorIcon rt-DropdownMenuItemIndicatorIcon" />
...
>((props, forwardedRef) => {
  ...
  return (
    ...
    >
      {children}
      <div class="rt-BaseMenuShortcut rt-DropdownMenuShortcut">
        <ThickChevronRightIcon class="rt-BaseMenuSubTriggerIcon rt-DropdownMenuSubtriggerIcon" />
      </div>
    </DropdownMenuPrimitive.SubTrigger>
  )
})
...
>(({ className, ...props }, forwardedRef) => (
  <DropdownMenuPrimitive.Separator
    {...props}
    ref={React.coerceRef(forwardedRef)}
    class={classNames('rt-BaseMenuSeparator', 'rt-DropdownMenuSeparator', className)}
  />
))
