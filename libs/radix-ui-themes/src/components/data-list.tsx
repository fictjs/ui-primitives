...
const DataListItem = React.forwardRef<DataListItemElement, DataListItemProps>(
  (props, forwardedRef) => {
    ...
    return (
      <div {...itemProps} ref={React.coerceRef(forwardedRef)} class={classNames('rt-DataListItem', className)} />
    );
  },
);
...
const DataListValue = React.forwardRef<DataListValueElement, DataListValueProps>(
  ({ children, className, ...props }, forwardedRef) => (
    <dd {...props} ref={React.coerceRef(forwardedRef)} class={classNames(className, 'rt-DataListValue')}>
      {children}
    </dd>
  ),
);
