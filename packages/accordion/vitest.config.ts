...
export default defineConfig({
  resolve: {
    alias: [
      {
        find: '@fictjs/accordion',
        replacement: path.resolve(packagesRoot, 'accordion/src/index.ts'),
      },
      {
      ...
      {
        find: '@fictjs/collapsible',
        replacement: path.resolve(packagesRoot, 'collapsible/src/index.tsx'),
      },
      {
