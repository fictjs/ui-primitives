...
export default defineConfig({
  resolve: {
    alias: [
      {
        find: '@fictjs/alert-dialog',
        replacement: path.resolve(packagesRoot, 'alert-dialog/src/index.ts'),
      },
      {
      ...
      {
        find: '@fictjs/dialog',
        replacement: path.resolve(packagesRoot, 'dialog/src/index.ts'),
      },
      {
      ...
      {
        find: '@fictjs/focus-guards',
        replacement: path.resolve(packagesRoot, 'focus-guards/src/index.tsx'),
      },
      {
