...
function DropdownMenuTrigger(props: ScopedProps<DropdownMenuTriggerProps>): FictNode {
  const context = useDropdownMenuContext(
    TRIGGER_NAME,
    props.__scopeDropdownMenu as Scope<DropdownMenuContextValue | undefined>,
  )
  const menuScope = useMenuScope(props.__scopeDropdownMenu)
  const disabled = () =>
...
function DropdownMenuContent(props: ScopedProps<DropdownMenuContentProps>): FictNode {
  const __scopeDropdownMenu = props.__scopeDropdownMenu
  const context = useDropdownMenuContext(
    CONTENT_NAME,
  ...
  return createMenuComponentNode(
    ...
    props as Record<string, unknown>,
    {
      ...
      'aria-labelledby': prop(context.triggerId),
      side: prop(side),
      align: prop(align),
